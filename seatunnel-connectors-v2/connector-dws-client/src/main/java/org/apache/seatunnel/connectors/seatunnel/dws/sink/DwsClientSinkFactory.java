...
public final class DwsClientSinkFactory implements TableSinkFactory {
    @Override
    ...
    public OptionRule optionRule() {
        return DwsClientOptions.optionRule();
    }
    ...
    public TableSink createSink(TableSinkFactoryContext context) {
        ...
        DwsSinkConfig config = DwsClientOptions.from(options);
        return () -> new DwsClientSink(config, table.getSeaTunnelRowType());
    }
}
